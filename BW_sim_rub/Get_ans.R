...
ATE_Combined = test_ATE(effect = 1, item = 1000,
...
ATE_Truncated = test_ATE(effect = 1, item = 1000,
...
ATE_Overlap = test_ATE(effect = 1, item = 1000,
...
causalTree_combined = test_algorithm(effect = E, Method = 'Combined', item = 1000,
...
causalTree_Truncated = test_algorithm(effect = E, Method = 'Truncated', 
...
causalTree_Overlap = test_algorithm(effect = E, Method = 'Overlap', item = 1000,
                              Alpha = Alpha, Beta = Beta, Gama = Gama,
                             inter_coef = 0.2875, BuckN = n, BuckM = m)
...
write.csv(ans, "ATE&CT_sq_ans_1st.csv")
