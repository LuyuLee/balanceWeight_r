...
ATE_Combined = Var_treetest_ATE(effect = E, item = 1000,
...
ATE_Truncated = Var_treetest_ATE(effect = E, item = 1000,
...
ATE_Overlap = Var_treetest_ATE(effect = E, item = 1000,
...
causalTree_combined = Var_test_Treedata(effect = E, Method = 'Combined', item = 1000,
...
causalTree_Truncated = Var_test_Treedata(effect = E, Method = 'Truncated', 
...
causalTree_Overlap = Var_test_Treedata(effect = E, Method = 'Overlap', item = 1000,
                                    Alpha = Alpha, Beta = Beta, Gama = Gama,
                                    inter_coef = 0.2875, BuckN = n, BuckM = m)
