...
ans_combined = list()
ans_combined = test_algorithm_ck(effect = E, Method = 'Combined', item = 1000,
...
ans_Truncated = test_algorithm_ck(effect = E, Method = 'Truncated', 
...
ans_Overlap = test_algorithm_ck(effect = E, Method = 'Overlap', item = 1000,
                             Alpha = Alpha, Beta = Beta, Gama = Gama,
                             inter_coef = 0.2875, BuckN = n, BuckM = m
                             , ck_effect = Effect, mul = 3.5)
